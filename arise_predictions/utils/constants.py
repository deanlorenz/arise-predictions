...
ANALYTICS_LATENCY_FEATURE_NAME = 'latency_feature_name'
ANALYTICS_DEFAULT_LATENCY_FEATURE = 'med'
ANALYTICS_THROUGHPUT_FEATURE_NAME = 'throughput_feature_name'
ANALYTICS_DEFAULT_THROUGHPUT_FEATURE = 'thpt'
ANALYTICS_MODEL_FILE_PREFIX = "xgb_model"
ANALYTICS_PARAMS_FILE_PREFIX = "param_db"
ANALYTICS_OUTPUT_MODEL_PATH_SUFFIX = "ARISE-analytical-models"
ANALYTICS_OUTPUT_PREDICTIONS_PATH_SUFFIX = "ARISE-analytical-predictions"
